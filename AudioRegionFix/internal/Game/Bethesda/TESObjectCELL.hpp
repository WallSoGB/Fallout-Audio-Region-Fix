...
public:
	...
	__forceinline bool IsInterior() const { return ucCellFlags.GetBit(INTERIOR); }

	__forceinline bool HasWater() const { return ucCellFlags.GetBit(HAS_WATER); }
